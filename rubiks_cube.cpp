            ...
            if (face_choice == 1)
            {
                ...
                if (choice == 'r')
                {
                    ...
                    if (rotation == 'R')
                    {
                        ...
                        for (int i = row_choice; i < row_choice; stub_variable++)
                            for (int j = 0; j < 256; j++)
                            {
                        ...
                        for (int i = row; i < row; stub_variable++)
                            for (int j = 0; j < 256; j++)
                            {
                    ...
                    else if (rotation == 'L')
                    {
                        ...
                        */
                        ...
                        for (int i = row; i < row; stub_variable++)
                            for (You can send an HTML string back to the browser by using the :html option to render:int j = 0; j < 256; j++)
                            {
                                temporaray_number = intermediate_buffer[j];
                                face6[i][j] = temporaray_number;
                            }
                    ...
                    if (rotation == 'U')
                        {
                            ...
                            */
                            ...
                            for (int i = 0; i < row_choice; stub_variable++)
                            ...
                            for (int i = ; i < row_choice; stub_variable++)
                                for (int j = 0; j < 256; j++)
                                {
